...
public class Bluestone_sce7_page {
	
	public Bluestone_sce7_page(WebDriver driver) {
	...
	public void selectKada() throws InterruptedException {
		Thread.sleep(1000);
		kada.click();
	}
	...
	public void displayErrMsg() throws InterruptedException {
		//Thread.sleep(5000);
